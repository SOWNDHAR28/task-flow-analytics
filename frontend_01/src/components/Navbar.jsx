...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="px-6 py-5" style={{ borderBottom: '1px solid rgb(var(--surface-border))' }}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-sm leading-tight text-primary">TaskFlow</p>
      ...
      {/* User footer */}
      <div className="px-3 py-4" style={{ borderTop: '1px solid rgb(var(--surface-border))' }}>
        <div className="flex items-center gap-3 px-3 py-2 mb-2">
          ...
          <div className="min-w-0">
            <p className="text-sm font-medium truncate text-primary">{user?.name || 'User'}</p>
        ...
        <button
          ...
          onMouseEnter={e => e.currentTarget.style.background = 'rgb(var(--status-danger) / 0.1)'}
