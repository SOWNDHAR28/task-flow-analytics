  ...
  return (
    <div className="flex items-center justify-between py-4"
      ...
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 rounded-xl flex items-center justify-center text-secondary"
  ...
  return (
    <div className="animate-fade-in max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="page-subtitle">Your account information and productivity stats</p>
      </div>
      ...
      <div className="card mb-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          {/* Avatar */}
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center text-white text-3xl font-bold shadow-glow flex-shrink-0"
          ...
          <div className="flex-1 text-center sm:text-left">
            {editing ? (
              ...
              <div>
                ...
                <p className="text-xs text-muted mt-1">Member since {joinDate}</p>
              </div>
            )}
          </div>
        </div>
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
              <StatBadge label="Total"     value={total}     color="rgb(var(--brand-400))" />
              <StatBadge label="Completed" value={completed} color="rgb(var(--status-success))" />
              <StatBadge label="Partial"   value={partial}   color="rgb(var(--status-warning))" />
              <StatBadge label="Pending"   value={pending}   color="rgb(var(--status-danger))" />
            </div>

            {/* Score ring */}
            <div className="flex flex-col sm:flex-row items-center gap-6 p-5 rounded-xl"
              style={{ background: 'rgb(var(--surface-hover))' }}>
              <div className="relative w-24 h-24 flex-shrink-0">
                <svg viewBox="0 0 100 100" className="rotate-[-90deg] w-full h-full">
                  <circle cx="50" cy="50" r="40" fill="none"
                    stroke="rgb(var(--surface-border))" strokeWidth="12" />
                  <circle cx="50" cy="50" r="40" fill="none"
                    stroke="url(#profileGrad)" strokeWidth="12"
                    strokeLinecap="round"
              ...
              <div>
                ...
                <p className="text-secondary text-sm mt-1">
                  Your productivity score is based on completed and partial tasks relative to total.
                  Completed = 1pt, Partial = 0.5pt.
                </p>
              </div>
            </div>
          </>
      ...
      {/* Danger zone */}
      <div className="card" style={{ borderColor: 'rgb(var(--status-danger) / 0.3)' }}>
